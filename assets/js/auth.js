...
function garantirCssMarca() {
  ...
  const link = document.createElement("link");
  link.rel = "stylesheet";
  link.href = portalPath("assets/css/portal-brand.css?v=20260818logo3");
...
function garantirMarcaPortal() {
  ...
  script.src = portalPath("assets/js/portal-brand.js?v=20260818logo3");
  script.defer = true;
...
function garantirThemeToggle() {
  ...
  const script = document.createElement("script");
  script.src = portalPath("assets/js/theme-toggle.js?v=20260818logo3");
  document.head.appendChild(script);
}
